...
function make(asset_type::Type{ThermalSteamCracker}, data::AbstractDict{Symbol,Any}, system::System)
    ...
    return ThermalSteamCracker(id, steamcracker_transform, elec_edge, h2_edge, natgas_consumption_edge, ethane_edge, ethylene_edge, co2_emission_edge, co2_captured_edge)
end